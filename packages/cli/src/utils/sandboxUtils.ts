...
import { debugLogger, POLLUX_DIR } from '@euxaristia/pollux-cli-core';

export const LOCAL_DEV_SANDBOX_IMAGE_NAME = 'pollux-cli-sandbox';
export const SANDBOX_NETWORK_NAME = 'pollux-cli-sandbox';
export const SANDBOX_PROXY_NAME = 'pollux-cli-sandbox-proxy';
...
export function entrypoint(workdir: string, cliArgs: string[]): string[] {
  ...
  const projectSandboxBashrc = `${POLLUX_DIR}/sandbox.bashrc`;
