...
/**
 * Decoupled LLM request format - stable across Pollux versions
 */
...
/**
 * Decoupled LLM response format - stable across Pollux versions
 */
...
/**
 * Decoupled tool configuration - stable across Pollux versions
 */
