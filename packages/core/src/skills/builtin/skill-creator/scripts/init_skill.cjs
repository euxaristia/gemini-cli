...
**Note:** Scripts may be executed without loading into context, but can still be read by Pollux for patching or environment adjustments.

### references/
Documentation and reference material intended to be loaded into context to inform Pollux's process and thinking.
...
**Appropriate for:** In-depth documentation, API references, database schemas, comprehensive guides, or any detailed information that Pollux should reference while working.
