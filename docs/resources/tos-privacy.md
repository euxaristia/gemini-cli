...
[Apache 2.0 license](https://github.com/google-gemini/pollux-cli/blob/main/LICENSE).
...
[Usage Statistics Configuration](https://github.com/google-gemini/pollux-cli/blob/main/docs/reference/configuration.md#usage-statistics).
