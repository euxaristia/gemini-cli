...
## Step 6: Add a custom `POLLUX.md`

Provide persistent context to the model by adding a `POLLUX.md` file to your
extension. This is useful for setting behavior or providing essential tool
information.

1.  Create a file named `POLLUX.md` in the root of your extension directory:
...
Restart Gemini CLI. The model now has the context from your `POLLUX.md` file in
