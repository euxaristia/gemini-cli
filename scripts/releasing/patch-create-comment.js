...
async function main() {
  const argv = await yargs(hideBin(process.argv))
    ...
    .example(
      '$0 --original-pr 8655 --exit-code 0 --commit abc1234 --channel preview --repository google-gemini/pollux-cli --test',
      'Test success comment',
    )
    .example(
      '$0 --original-pr 8655 --exit-code 1 --commit abc1234 --channel stable --repository google-gemini/pollux-cli --test',
  ...
  const repository =
    argv.repository || process.env.REPOSITORY || 'google-gemini/pollux-cli';
